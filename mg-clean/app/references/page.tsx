        ...
        <div className="relative w-full h-[400px] rounded-3xl overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-start pl-28 pr-8 pt-16 z-20">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-white">
              Our <span className="text-[#3AA655]">references</span>
            </h1>
            <p className="max-w-[600px] text-[16px] mt-2 leading-relaxed text-white">
              Successful projects, satisfied customers and measurable results
            </p>
          </div>
        </div>
      </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col items-center gap-4 p-6">
              ...
              <span className="text-lg font-medium">Public administrations</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6">
              ...
              <span className="text-lg font-medium">Practices</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6">
              ...
              <span className="text-lg font-medium">Industrial companies</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6">
              ...
              <span className="text-lg font-medium">Retail</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6">
              ...
              <span className="text-lg font-medium">Fitness center</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 p-6">
              ...
              <span className="text-lg font-medium">Public institutions</span>
            </div>
          </div>
        </section>
      </div>
