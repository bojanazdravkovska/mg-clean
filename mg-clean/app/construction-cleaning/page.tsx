        ...
        <div className="relative w-full h-[400px] rounded-3xl overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-start pl-28 pr-8 pt-16 z-20">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-white">
              Construction <span className="text-[#3AA655]">Cleaning </span>
            </h1>
            <p className="max-w-[600px] text-[16px] mt-2 leading-relaxed text-white">
              Professional construction cleaning services to keep your construction site in perfect condition
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4 order-1">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
                Construction cleaning - to the finishing touch
              </h2>
              <div className="w-full max-w-[500px] h-[2px] bg-[#5A7D8C] mb-6" />
              <p className="text-gray-600 text-lg text-justify mb-4">
                Do you want a flexible and competent construction cleaning partner to carry out construction cleaning for you throughout the entire construction phase ? Then you&apos;ve come to the right place! We&apos;ll accompany you from the start of construction to the handover of the keys, ensuring your construction site remains clean and well-maintained from start to finish.
              </p>
            </div>
            ...
            {/* Construction Cleaning by Experts - now last section */}
            <section className="w-full py-12 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            {/* Left: Construction Cleaning Image */}
            ...
            <div className="space-y-6 order-2 flex flex-col justify-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
                Construction Cleaning by Experts
              </h2>
              <p className="text-gray-700 text-lg mb-4">
                Our team delivers reliable construction cleaning, from rough site cleanups to the final polish before handover. We coordinate with all parties to ensure your project is spotless, safe, and ready for its next phase. With flexible scheduling and attention to detail, we make sure nothing is left to chance—so you can focus on building, not cleaning.
              </p>
              <ul className="space-y-2 text-base text-gray-800">
                <li className="flex items-center gap-2"><span className="text-[#3AA655]">✔</span> Free site visits & consultation</li>
                <li className="flex items-center gap-2"><span className="text-[#3AA655]">✔</span> Delivery guarantee for every project</li>
                <li className="flex items-center gap-2"><span className="text-[#3AA655]">✔</span> Fast response & flexible timing</li>
                <li className="flex items-center gap-2"><span className="text-[#3AA655]">✔</span> Modern equipment & eco-friendly methods</li>
                <li className="flex items-center gap-2"><span className="text-[#3AA655]">✔</span> Fully insured & certified team</li>
              </ul>
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mt-4">
                <span className="font-semibold text-lg">You can contact us anytime!</span>
