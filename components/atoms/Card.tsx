...
export default function Card({ title, description, image, link, className = "" }: CardProps) {
  return (
    <Link href={link} className={`block h-full ${className}`}>
      <div className="group relative overflow-hidden rounded-lg bg-white transition-all hover:shadow-md border border-gray-100 flex flex-col h-full">
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="inline-flex items-center text-[#3AA655] font-medium hover:underline mt-4">
